                  ...
                  <table id="trfMemberInquiry" class="table table-striped">
                      <tbody>
                        <tr>
                          ...
                          <td width="150"> : </td>
                          <td align="right">Agent Account</td>
                        </tr>
                        <tr>
                          <td width="150">To Member</td>
                          <td width="150"> : </td>
                          <td align="right">Agent Deposit Account</td>
                        </tr>
                        <tr>
                    ...
                    <hr/>
                    <form id="transfermemberform" data-parsley-validate action="/admin/transferAgentPayment" method="POST" modelAttribute="transfermember" class="form-horizontal form-label-left">
                          ...
                          <input type="hidden" name="toMember" id="toMember" value="${member.username}-${member.name}" readonly required="required" class="form-control col-md-7 col-xs-12">
