 ...
 * 2018-11-02T13:53:10.117+07:00
 * Generated source version: 2.7.15
 * 
 */
@WebServiceClient(name = "AccountService", 
                  wsdlLocation = "http://149.129.214.53:8081/bellatrix/host/services/ws/accounts?wsdl",
                  targetNamespace = "http://services.bellatrix.org/") 
public class AccountService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://services.bellatrix.org/", "AccountService");
    public final static QName AccountPort = new QName("http://services.bellatrix.org/", "AccountPort");
    static {
        URL url = null;
        try {
            url = new URL("http://149.129.214.53:8081/bellatrix/host/services/ws/accounts?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://149.129.214.53:8081/bellatrix/host/services/ws/accounts?wsdl");
        }
        WSDL_LOCATION = url;
    }
