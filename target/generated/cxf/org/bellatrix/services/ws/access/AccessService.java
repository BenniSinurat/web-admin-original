 ...
 * 2018-11-02T13:53:09.475+07:00
 * Generated source version: 2.7.15
 * 
 */
@WebServiceClient(name = "AccessService", 
                  wsdlLocation = "http://149.129.214.53:8081/bellatrix/host/services/ws/access?wsdl",
...
public class AccessService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://149.129.214.53:8081/bellatrix/host/services/ws/access?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccessService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://149.129.214.53:8081/bellatrix/host/services/ws/access?wsdl");
        }
        WSDL_LOCATION = url;
    }
