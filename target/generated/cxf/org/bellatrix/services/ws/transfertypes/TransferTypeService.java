 ...
 * 2018-11-02T13:53:11.520+07:00
 * Generated source version: 2.7.15
 * 
 */
@WebServiceClient(name = "TransferTypeService", 
                  wsdlLocation = "http://149.129.214.53:8081/bellatrix/host/services/ws/transfertypes?wsdl",
...
public class TransferTypeService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://149.129.214.53:8081/bellatrix/host/services/ws/transfertypes?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TransferTypeService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://149.129.214.53:8081/bellatrix/host/services/ws/transfertypes?wsdl");
        }
        WSDL_LOCATION = url;
    }
