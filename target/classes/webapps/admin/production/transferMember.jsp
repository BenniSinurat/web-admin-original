            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="transfermemberform" data-parsley-validate action="/admin/transferMemberInquiry" method="POST" modelAttribute="transfermember" class="form-horizontal form-label-left">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="trffromAccount">From Account :</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="fromAccount" id="fromAccount" value="Partner Deposit Account" readonly required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="toMember" class="select2_single form-control" tabindex="-1">
                            <option>Select Member</option>
		                    <c:forEach var="listMember" items="${listMember}">
							  <option name="toMember" id="toMember" value="${listMember}">${listMember}</option>
							</c:forEach>
                          </select>
                        </div>
                      </div>
