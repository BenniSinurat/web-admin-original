                      ...
                      'csvHtml5'
       				 ...
       				 "columns" : [ {
								...
								"render" : function ( data, type, row ) {
                   					 return "<a href='reverseInquiry?transactionNumber=" + data.transactionNumber + "&description=" + data.description + "&remark=" + data.remark + "&transactionDate=" + data.transactionDate + "&amount=" + data.amount + "&toFromMember=" + data.toFromMember + "&traceNumber=" + data.traceNumber+"'>Reverse</a>";
               					}
							}]
					});
	</script>
