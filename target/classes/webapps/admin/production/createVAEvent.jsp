              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div class="x_content">
        			 <br />
                    <form id="vaeventform" data-parsley-validate action="/admin/createVAEventForm" method="POST" modelAttribute="vaevent" class="form-horizontal form-label-left">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="eventName">Event Organizer <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="eventName" name="eventName" value="${member.name}" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
