                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     <form id="changecredentialform" data-parsley-validate class="form-horizontal form-label-left" action="/admin/changeCredentialResult" method="POST" modelAttribute="changecredential" >
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Old Password :</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">New Password :</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
