            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="topupagentform" data-parsley-validate action="/admin/topupAgentInquiry" method="POST" modelAttribute="topupagent" class="form-horizontal form-label-left">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="trffromAccount">From Account :</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="fromAccount" id="fromAccount" value="Rekening VA" readonly required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
