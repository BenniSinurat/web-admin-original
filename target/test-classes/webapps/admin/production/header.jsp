        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index" class="site_title"><i class="fa fa-paw"></i><span> OPTIMA</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                  	<li><a href="changeCredential"> Change Password</a></li>
                    <li>
                    	<a href="setting"><i class="fa fa-gear pull-right"></i> Setting</a>
                      <!--<a href="javascript:;">
