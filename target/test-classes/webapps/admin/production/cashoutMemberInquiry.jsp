            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-24">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <br />
                  <table id="cashoutMemberInquiry" class="table table-striped">
                      <tbody>
                        <tr>
                    ...
                    <hr/>
                    <form id="cashoutmemberform" data-parsley-validate action="/admin/cashoutMemberPayment" method="POST" modelAttribute="cashoutmember" class="form-horizontal form-label-left">
                  		  <input type="hidden" name="fromAccount" id="fromAccount" value="${fromAccount}" readonly required="required" class="form-control col-md-7 col-xs-12">
                          <input type="hidden" name="toAccount" id="toAccount" value="${member.username}" readonly required="required" class="form-control col-md-7 col-xs-12">
                          ...
                          <input type="hidden" id="otp" name="otp" readonly required="required" value="${otp}" class="form-control col-md-7 col-xs-12">
